...
exports.initPlayers = void 0;
var initPlayer = function initPlayer(videoContainer) {
  var videoPlay = videoContainer.querySelector('.video [data-play-button]');
  var videoId = videoPlay.dataset.videoId;
...
var sectionClassName = 'coaches';
var coachesContainer = document.querySelector(".".concat(sectionClassName));
var initCoachesSlider = function initCoachesSlider() {
  if (coachesContainer) {
    return new _swiper.default("[data-slider-wrapper=\"".concat(sectionClassName, "\"]"), {
      grabCursor: true,
      loop: true,
      speed: 600,
      breakpoints: {
      ...
      navigation: {
        prevEl: "[data-slider-prev-button=\"".concat(sectionClassName, "\"]"),
        nextEl: "[data-slider-next-button=\"".concat(sectionClassName, "\"]")
      }
    });
  }
  return null;
...
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var sectionClassName = 'reviews';
var reviewsContainer = document.querySelector(".".concat(sectionClassName));
