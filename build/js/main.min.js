...
var _player = require("./modules/player/player");
var _initTabs = require("./modules/tabs/init-tabs");
var _coachesSlider = require("./modules/sliders/coaches-slider");
var _reviewsSlider = require("./modules/sliders/reviews-slider");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    (0, _player.initPlayer)();
    (0, _initTabs.initTabs)();
    (0, _coachesSlider.initCoachesSlider)();
    (0, _reviewsSlider.initReviewsSlider)();
...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/player/player":11,"./modules/sliders/coaches-slider":12,"./modules/sliders/reviews-slider":13,"./modules/tabs/init-tabs":14,"./utils/ios-vh-fix":17}],2:[function(require,module,exports){
"use strict";
...
exports.initPlayer = void 0;
var videoWrapper = document.querySelector('.gym__video-wrapper');
var playButton = document.querySelector('.gym__video-button');
...
var sliderList = document.querySelector('.coaches .slider__list');
var sliderItems = document.querySelectorAll('.coaches .slider__item');
var duplicateSlides = function duplicateSlides() {
  return sliderList.append.apply(sliderList, _toConsumableArray(Array.from(sliderItems).map(function (item) {
    return item.cloneNode(true);
  })));
};
var initCoachesSlider = function initCoachesSlider() {
  duplicateSlides();
  var swiper = new _swiper.default('.coaches__slider-wrapper', {
    grabCursor: true,
    loop: true,
    speed: 600,
    breakpoints: {
...
},{"../../vendor/swiper":18}],13:[function(require,module,exports){
"use strict";
...
function _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
var sliderList = document.querySelector('.reviews .slider__list');
var sliderItems = document.querySelectorAll('.reviews .slider__item');
var duplicateSlides = function duplicateSlides() {
  return sliderList.append.apply(sliderList, _toConsumableArray(Array.from(sliderItems).map(function (item) {
    return item.cloneNode(true);
  })));
...
var initReviewsSlider = function initReviewsSlider() {
  duplicateSlides();
  var swiper = new _swiper.default('.reviews__slider-wrapper', {
    grabCursor: true,
    speed: 600,
    slidesPerView: 1,
    spaceBetween: 50,
